...
const iconOptions = [
    ...
    { name: "FaRadiation", label: "Radiation Incident" },
    { name: "FaExclamationTriangle", label: "General Hazard" },
    { name: "FaTint", label: "Flood" },
    { name: "FaWater", label: "Water Rescue" },
    { name: "FaWind", label: "Strong Winds" },
    { name: "FaCloudShowersHeavy", label: "Heavy Rainfall" },
    { name: "FaMountain", label: "Earthquake" },
    { name: "FaHouseDamage", label: "Building Collapse" },
    { name: "FaGlobeAsia", label: "Landslide" },
    { name: "FaHeartbeat", label: "Medical Emergency" },
    { name: "FaUserInjured", label: "Trauma" },
    { name: "FaSkullCrossbones", label: "Poisoning" },
    { name: "FaVirus", label: "Infectious Disease" },
    { name: "FaCarCrash", label: "Vehicular Accident" },
    { name: "FaBusAlt", label: "Bus Accident" },
    { name: "FaMotorcycle", label: "Motorcycle Accident" },
    { name: "FaSubway", label: "Train Incident" },
    { name: "FaPaw", label: "Animal Attack / Bite" },
    { name: "FaSpider", label: "Insect/Spider Bite" },
    { name: "FaBolt", label: "Power Interruption" },
    { name: "FaGasPump", label: "Gas Leak" },
    { name: "FaLungs", label: "Choking" },
];
